var sticky_copy = {
    //links
    nutcalc_nutCalGetNutrition:  "/ca/fr/php/nutCalGetNutrition.php",

    //text
    nutcalc_sticky_menu: "sticky_menu_",


        nutcalc_country: "ca", nutcalc_lang: "fr", 


    nutcalc_no_specific_product: "Aucun produit n'est associé à votre recherche. Veuillez réessayer.",
    nutcalc_product_limit: "Au maximum, 20 produits peuvent s'ajouter à votre repas. Pour ajouter ce produit du menu, veuillez retirer un autre produit de votre repas.",
